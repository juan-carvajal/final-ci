...
public class TsscTopic implements Serializable {
	...
	@Min(value=1,message="Este atributo debe tener un valor mayor a 0.")
	...
	public TsscTimecontrol addTimeControl(TsscTimecontrol tc) {
		this.tsscTimeControls.add(tc);
		tc.setTsscTopic(this);
		return tc;
	}
	
	public void setTsscTimeControls(List<TsscTimecontrol> timeControls){
		this.tsscTimeControls=timeControls;
	}
